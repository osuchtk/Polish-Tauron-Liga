...
def getInformations(linksList): #, dataframe, filename):
    ...
    for index, link in enumerate(linksList):
        ...
        linksPageList.append(linkToPage)

    return clubList, birthDateList, positionList, heightList, weightList, rangeList, linksPageList
